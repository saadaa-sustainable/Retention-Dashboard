...
const FORMAT_SPECS: Record<ExportType, FormatSpec> = {
  campaigns: {
    ...
    example: [
      ...
      ['C135_RET_WA_ATC>1_P-L30D_IMG_SUMMER300_CFY','whatsapp','29902','26982','2026-05-31','92734.05','segment - Included Segment\\nATC>1_P-L30D\\nExcluded Segment\\nATC>0_NP-L30D'],
      ['C103_RET_4000<LTV_LOD_Within_365D_USP_IMG_OF-RAHOSAADAA_LD','whatsapp','1024','856','2026-05-18','42130','segment - Included Segment\\n4000<LTV_LOD_Within_365D'],
    ],
    notes: [
      'Channel values: whatsapp · sms · email · rcs (lowercase).',
      'Date format: YYYY-MM-DD (preferred) or DD-MM-YYYY.',
      'Source column can span multiple lines (CSV-quoted). Segment is parsed from the line after "Included Segment". Anything under "Excluded Segment" is ignored.',
  ...
  automations: {
    ext: '.csv',
    required: ['Name','Channel','Sent','Delivered','Seen','CTR','Clicks','Buyers','Unsubscribers','Cost','ROAS'],
    optional: ['Sales','Orders','Recovered Amount','Recovered Carts','Date (per-row)'],
    example: [
      ['Name','Channel','Sent','Delivered','Seen','CTR','Clicks','Buyers','Unsubscribers','Recovered Amount','Recovered Carts','Cost','ROAS'],
      ['GK_ABC1_15mins','whatsapp','4960','3059','2172','12.36%','378','112','5','171208.26','112','2657.85','64.42'],
      ['Abandoned Checkout SMS','sms','6144','4153','0','2.46%','102','15','0','27604.93','15','2117.61','13.04'],
      ['GK ABC - T2','whatsapp','2711','526','347','NA','0','1','0','649','1','456.75','1.42'],
    ],
    notes: [
      'Either include a per-row Date column, OR pick a single snapshot date / date range in the field above.',
